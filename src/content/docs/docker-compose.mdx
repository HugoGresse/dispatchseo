...
"terminal"). On Windows you need either
[Git Bash](https://git-scm.com/downloads/win) - the simpler option, it comes
with Git and installs like any app - or
[WSL](https://learn.microsoft.com/windows/wsl/install). Plain PowerShell
can't run this command, so install one of those two first if you haven't.
