...
out is where your articles will go: either a self-hosted WordPress site, or a
GitHub repo that receives them as pull requests. Hosted site builders like
Wix and Squarespace have neither and can't work that way.
