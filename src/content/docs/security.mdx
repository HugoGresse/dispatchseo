...
- **Anthropic or OpenAI** - the builder container runs your own coding
  agent headlessly: Claude Code on your subscription, or Codex metered
  against your OpenAI key. Only your project's chosen agent is called.
...
| `CURSOR_API_KEY` (builder, Cursor projects) | Encrypted in your database, or in `.env` (env always wins) | Runs Cursor headlessly on your paid Cursor plan | Revoke it in your Cursor dashboard, create a fresh one, paste it into the same box |
