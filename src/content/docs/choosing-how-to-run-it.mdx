...
<Callout type="note" title="You still bring your own AI">
Both versions run on an AI you already pay for: the ordinary Claude app at
claude.ai, Claude Code on your Claude subscription,
[Codex](/docs/install-codex) on an OpenAI key, or
[Cursor](/docs/install-cursor) on your Cursor plan. Neither version bills
you for that usage, and neither can work without an AI connected.
</Callout>
