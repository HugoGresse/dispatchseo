...
Both versions run on your own coding agent - Claude Code on your Claude
subscription, [Codex](/docs/install-codex) on an OpenAI key, or
[Cursor](/docs/install-cursor) on a paid Cursor plan. Neither version
bills you for agent usage, and neither can work without an agent connected.
</Callout>
