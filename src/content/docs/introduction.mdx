...
DispatchSEO turns your coding agent into the person who handles your SEO.
...
- **You already pay for Claude Code or Codex.** Your agent is the engine, and it
  runs on the plan or key you have. DispatchSEO never bills you for agent usage.
