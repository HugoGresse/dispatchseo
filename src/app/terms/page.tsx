    ...
    <main className="mx-auto max-w-2xl space-y-8 px-6 py-16 text-neutral-300">
      ...
      <section className="space-y-3 text-sm leading-relaxed">
        ...
        <p>
          ...
          GitHub repository, Google Search Console account, and coding agent subscription
          (Claude Code or Codex); content is generated by that subscription, not by us. We provide
