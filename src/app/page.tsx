...
// Discord's own mark (Simple Icons, CC0) - the one logo on this page drawn as a
// solid fill rather than the round-capped outline the doodles use. A community
// badge has to be recognisable at 21px from the corner of the eye, and a
// redrawn-in-our-language Discord is just an unrecognisable blob.
function DiscordMark() {
  return (
    <svg className="dc-mark" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
